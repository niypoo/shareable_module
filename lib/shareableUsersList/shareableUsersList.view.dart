...
import 'package:shareable_module/shareableUsersList/layouts/landscape.view.dart';
  ...
  Widget build(BuildContext context) {
    return FlyScaffold.padding(
      child: const FlyLayoutResponsiveView(
        portrait: ShareableUsersListPortraitView(),
        landscape: ShareableUsersListLandscapeView(),
      ),
    );
  }
}
